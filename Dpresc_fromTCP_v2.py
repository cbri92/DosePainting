...
for current in subjs_name:
    ...
    cell_dir = data_supradir+current+'/MRI/baseline/noBone/' #Path to dir with noBone data
    ...
    sitk.WriteImage(cell_map, cell_dir+'cellApp_CORRECTED.nii') #Write cellularity map in valid voxels in noBone dir
    
    ctv_ok=sitk.ReadImage(data_supradir+current+'/MRI/baseline/orig/ctv_voxel_ok_3D.nii.gz', sitk.sitkUInt8) #Read mask of CTV voxels that have valid values of ADC
