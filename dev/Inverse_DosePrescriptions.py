...
for current in subjs_name:
    ...
    DP_noBoneDWI = sitk.ReadImage(dose_dir +'/Dose_optimised_CTVnoBone_final54.nii')
    ...
    sitk.WriteImage(DP_noBoneCT_inPTV, prsc_dir +'/DP_noBone_54.nii')
    
    # sitk.WriteImage(Inv_DP_origCT_inPTV, prsc_dir +'/Inv_DP_orig.nii')
    sitk.WriteImage(Inv_DP_noBoneCT_inPTV, prsc_dir +'/Inv_DP_noBone_54.nii')
    ...
    convert_nii_to_dicom_RTdosefile(Inv_DP_noBoneCT_inPTV, ct_ref, output_directory=prsc_dir, out_filename="Inv_DP_noBone_54.dcm")
