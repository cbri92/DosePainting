...
This script register GTV into DWI MRI space.
"""
...
for current in subjs_name:
    ...
    #Read GTV
    # GTV = sitk.ReadImage(subj_dir+'/RTSTRUCT/GTV.nii')
    GTV = sitk.ReadImage(subj_dir+'/RTSTRUCT/GTV_AIRC24946.nii')
    #Read CT
    ...
    #%%Generate GTV in DWI excluding bones
    
    # bone_mask = CT_reg>100
    # bone_mask = GTV_reg*bone_mask
    # GTV_noBone = GTV_reg-bone_mask   
    # sitk.WriteImage(GTV_noBone, subj_dir+'MRI/baseline/noBone/GTV_inDWI_noBone.nii')
