...
TCPpop = 0.5 #LC of SC patients 24/48 with LC
...
#     problem where TCP = 0.5, for known N0 and Dlq arrays.
...
alphaPOP0 = 0.2
x = minimize(function, alphaPOP0, args=(Np, TCPpop, N0, D98), method='Nelder-Mead', tol=1e-20)
